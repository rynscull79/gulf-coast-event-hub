...
export default function TentRentalsPensacola() {
  return (
    <div className="page">
      ...
      <section className="section">
        <div className="sectionHeadingWrap">
          ...
          <h1 className="sectionTitle">
            Tent Rentals in Pensacola for Weddings, Parties & Events
          </h1>

          <p className="sectionText">
            Looking for tent rentals in Pensacola? Gulf Coast Event Hub helps
            connect customers with tent rental options for weddings, private
            parties, outdoor receptions, corporate gatherings, and other Gulf
            Coast events.
          </p>
        </div>
      ...
      <section className="section sectionAlt">
        <div className="sectionHeadingWrap">
          <h2 className="sectionTitle">
            Tent Rental Options for Pensacola Events
          </h2>

          <p className="sectionText">
            Whether you need a small tent for a backyard event or a larger setup
            for a wedding or reception, we help simplify the booking process.
        ...
        <div className="cardGrid">
          <div className="serviceCard">
            <div className="serviceCardContent">
              ...
              <p className="cardText">
                Tent options for weddings, ceremonies, receptions, and rehearsal
                dinners in Pensacola.
              </p>
            </div>
          </div>
          ...
          <div className="serviceCard">
            <div className="serviceCardContent">
              ...
              <p className="cardText">
                Tent setups for company events, business gatherings, and
                community functions.
              </p>
            </div>
          </div>
      ...
      <section className="section">
        <div className="sectionHeadingWrap">
          <h2 className="sectionTitle">Book Tent Rentals in Pensacola</h2>
          <p className="sectionText">
