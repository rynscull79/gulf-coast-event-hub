...
export default function WeddingBartendersOrangeBeach() {
  return (
    <div className="page">
      ...
      <section className="section">
        <div className="sectionHeadingWrap">
          ...
          <h1 className="sectionTitle">
            Wedding Bartenders in Orange Beach for Receptions & Events
          </h1>

          <p className="sectionText">
            Looking for wedding bartenders in Orange Beach? Gulf Coast Event Hub
            helps connect couples and event hosts with bartending services for
            wedding receptions, rehearsal dinners, cocktail hours, and other
            special events along the Gulf Coast.
          </p>
        </div>
      ...
      <section className="section sectionAlt">
        <div className="sectionHeadingWrap">
          <h2 className="sectionTitle">
            Bartending Services for Weddings in Orange Beach
          </h2>

          <p className="sectionText">
            Whether you need bartenders for a beach wedding reception, cocktail
            hour, private venue event, or rehearsal dinner, we help make the
            booking process simpler. Submit one request and we help move the
            vendor matching process forward.
          </p>
        </div>
        ...
        <div className="cardGrid">
          <div className="serviceCard">
            <div className="serviceCardContent">
              ...
              <p className="cardText">
                Bartending options for wedding receptions in Orange Beach and
                nearby Gulf Coast venues.
              </p>
            </div>
          </div>
          ...
          <div className="serviceCard">
            <div className="serviceCardContent">
              ...
              <p className="cardText">
                Bartender service for cocktail hours and guest drink service
      ...
      <section className="section">
        <div className="sectionHeadingWrap">
          <h2 className="sectionTitle">Book Wedding Bartenders in Orange Beach</h2>
          <p className="sectionText">
