...
export default function BartendersDaphne() {
  return (
    <div className="page">
      ...
      <section className="section">
        <div className="sectionHeadingWrap">
          ...
          <h1 className="sectionTitle">
            Bartenders in Daphne for Weddings, Parties & Events
          </h1>

          <p className="sectionText">
            Looking for bartenders in Daphne? Gulf Coast Event Hub helps connect
            customers with bartending services for weddings, private parties,
            corporate events, outdoor gatherings, and other celebrations along
            the Gulf Coast.
          </p>
        </div>
      ...
      <section className="section sectionAlt">
        <div className="sectionHeadingWrap">
          <h2 className="sectionTitle">
            Bartending Services for Daphne Events
          </h2>
      ...
      <section className="section">
        <div className="sectionHeadingWrap">
          <h2 className="sectionTitle">Book Bartenders in Daphne</h2>
          <p className="sectionText">
  ...
  <div className="cardGrid">
    <div className="serviceCard">
      <div className="serviceCardContent">
        <h3 className="cardTitle">
          <Link to="/wedding-bartenders-daphne">
            Wedding Bartenders in Daphne
          </Link>
        </h3>
        <p className="cardText">
    ...
    <div className="serviceCard">
      <div className="serviceCardContent">
        <h3 className="cardTitle">
          <Link to="/frozen-drink-machine-rentals-daphne">
            Frozen Drink Machine Rentals in Daphne
          </Link>
        </h3>
        <p className="cardText">
    ...
    <div className="serviceCard">
      <div className="serviceCardContent">
        <h3 className="cardTitle">
          <Link to="/bartenders-fairhope">
            Bartenders in Fairhope
          </Link>
        </h3>
        <p className="cardText">
    ...
    <div className="serviceCard">
      <div className="serviceCardContent">
        <h3 className="cardTitle">
          <Link to="/table-and-chair-rentals-daphne">
            Table and Chair Rentals in Daphne
          </Link>
        </h3>
        <p className="cardText">
          Complete your event setup with tables, seating, and essentials.
        </p>
      </div>
    </div>
  </div>
