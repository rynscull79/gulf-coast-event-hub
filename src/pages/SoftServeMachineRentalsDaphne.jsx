...
export default function SoftServeMachineRentalsDaphne() {
  return (
    <div className="page">
      ...
      <section className="section">
        <div className="sectionHeadingWrap">
          ...
          <h1 className="sectionTitle">
            Soft Serve Machine Rentals in Daphne for Parties & Events
          </h1>

          <p className="sectionText">
            Looking for soft serve machine rentals in Daphne? Gulf Coast Event
      ...
      <section className="section sectionAlt">
        <div className="sectionHeadingWrap">
          <h2 className="sectionTitle">
            Soft Serve Machine Options for Daphne Events
          </h2>

          <p className="sectionText">
            Soft serve machines are a fun and memorable addition to many types of
            events. Whether you're planning a small gathering or a larger event,
      ...
      <section className="section sectionAlt">
        ...
        <div className="stepsGrid">
          ...
          <div className="stepCard">
            ...
            <p className="cardText">
              Yes. You can request soft serve machines along with other rentals
              and event services in one quote request.
            </p>
          </div>
      ...
      <section className="section">
        <div className="sectionHeadingWrap">
          <h2 className="sectionTitle">
            Book a Soft Serve Machine in Daphne
          </h2>
          <p className="sectionText">
