...
export default function IceCreamCartRentalsDaphne() {
  return (
    <div className="page">
      ...
      <section className="section">
        <div className="sectionHeadingWrap">
          ...
          <h1 className="sectionTitle">
            Ice Cream Cart Rentals in Daphne for Parties & Events
          </h1>

          <p className="sectionText">
            Looking for ice cream cart rentals in Daphne? Gulf Coast Event Hub
      ...
      <section className="section sectionAlt">
        <div className="sectionHeadingWrap">
          <h2 className="sectionTitle">
            Ice Cream Cart Options for Daphne Events
          </h2>
      ...
      <section className="section">
        <div className="sectionHeadingWrap">
          <h2 className="sectionTitle">
            Book an Ice Cream Cart in Daphne
          </h2>
          <p className="sectionText">
