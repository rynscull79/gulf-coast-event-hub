...
export default function SoftServeMachineRentalsFairhope() {
  return (
    <div className="page">
      ...
      <section className="section">
        <div className="sectionHeadingWrap">
          ...
          <h1 className="sectionTitle">
            Soft Serve Machine Rentals in Fairhope for Parties & Events
          </h1>

          <p className="sectionText">
            Looking for soft serve machine rentals in Fairhope? Gulf Coast Event
      ...
      <section className="section sectionAlt">
        <div className="sectionHeadingWrap">
          <h2 className="sectionTitle">
            Soft Serve Machine Options for Fairhope Events
          </h2>
      ...
      <section className="section">
        <div className="sectionHeadingWrap">
          <h2 className="sectionTitle">
            Book a Soft Serve Machine in Fairhope
          </h2>
          <p className="sectionText">
